...
public class LeavePartyCommand extends AbstractAsyncCommand {
   public LeavePartyCommand() {
      super("leave", "Leaves your current party");
            ...
            return CompletableFuture.runAsync(() -> {
               ...
               if (playerRef != null) {
                  ...
                  if (party == null) {
                     ...
                     PartyManager.getInstance().leaveParty(playerRef, party);
                     NotificationHelper.sendSuccess(playerRef, LanguageManager.getInstance().get("title.party"), LanguageManager.getInstance().get("success.party_left"));
                  }
               }
            }, world);
         } else {
